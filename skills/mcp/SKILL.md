...
# Stellar Agent MCP — discover, rank and vet Stellar 8004 agents
...
> This skill documents how to register and use the **stellar-agent-mcp** server — a **READ-ONLY, key-less** stdio MCP
...
```bash
codex mcp add stellar-agent --env STELLAR_NETWORK=mainnet -- npx -y stellar-agent-mcp@0.1.0 mcp
```
