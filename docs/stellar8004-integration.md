...
| Human CLI, MCP tools/resources/prompts, client setup | this repo | One install surface: `stellar-agent-search` |
...
consumers install `stellar-agent-search`, which depends on that exact SDK release internally.
