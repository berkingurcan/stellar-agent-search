...
const PACKAGE_NAME = "stellar-agent-mcp";
const CURSOR_LOCK_SUFFIX = ".stellar-agent-mcp.lock";
...
export async function runHandshake(
  ...
  const client = new Client({ name: "stellar-agent-mcp-setup", version }, { capabilities: {} });
