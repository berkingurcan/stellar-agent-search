...
`stellar-agent-search` is a **read-only, keyless** MCP server over a **permissionless mainnet registry**. Its
...
- **GitHub:** open a [private security advisory](https://github.com/berkingurcan/stellar-agent-search/security/advisories/new)
